      ...
      <div class="col-sm-6 col-md-12">
          <div class="box ">
            ...
            <div class="detail-box">
              <h5>
                Rekap Iuran Agustusan Warga San Dramaga Village
              </h5>
              <br>
              <p>
              <h2><strong>Rp. {{ number_format($total, 0, ',', '.') }}</strong></h2>
              <br>
              Total Iuran Agustusan Dari :<strong> {{$total_warga}} </strong> Warga <br>
            </p>
            </div>
          </div>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($list as $item)
                        ...
                        <tr>
                            ...
                            <td>@if($item->nominal > 80000) <b>Rp. {{ number_format($item->nominal, 0, ',', '.') }}</b> @elseif($item->nominal == 0) - @else Rp. {{ number_format($item->nominal, 0, ',', '.') }} @endif @endif</td>
